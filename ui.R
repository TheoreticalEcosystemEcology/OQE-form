...
shinyUI(fluidPage(theme = shinytheme("yeti"),
  ...
  sidebarLayout(position = "right",
    sidebarPanel(style = "overflow-y:scroll; max-height: 100vh !important", useShinyjs(),
    ...
    actionButton("erase", class = "btn-danger", label = "Effacer cette campagne")),
        ...
        p("Veuillez compléter les informations relatives à la campagne d'échantillonage que vous venez de localiser sur la carte.",style="font-style:italic;font-size:13px;"),
              div(useShinyjs(),
                  ...
                  radioButtons("share", label = h5("Est-ce que les données de cette campagne ont déjà été versées vers d'autres bases de données ouvertes?"),
                               choices = list("Oui" = 1, "Non" = 2), selected = 2,inline=TRUE),
                  conditionalPanel(
                    condition = "input.share == 1",
    ...
    HTML("<hr width='75%'>"),
    h4("Étape 4: Soumettre le formulaire"),
